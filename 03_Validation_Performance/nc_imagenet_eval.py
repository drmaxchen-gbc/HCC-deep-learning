"""A binary to evaluate Inception on the  data set.
Output generated:
** information for ROC curves with 2 aggregation methods (out_rate_PcTiles.txt, out_rate_ScoreTiles.txt)
...
tf.app.flags.DEFINE_string('labels_names', '/ifs/home/01_Data_03_Nomral and HCC.txt',
